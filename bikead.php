...
/* insert into databse */
 ...
 $sell="INSERT INTO `uploads`(`sid`, `make`, `model`, `year`, `price`, `contact`, `body_type`, `mileage`, `trans_type`, `bike_condition`, `engine_size`, `color`) VALUES ('$sid','$makename','$model','$year','$price','$contact','$body','$mileage','$trans','$condition','$size','$color')";
 if (!$sell){
