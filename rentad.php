...
$sq = "SELECT name FROM maketable WHERE mid =? ";
 ...
 $sell="INSERT INTO `rentals`(`sid`, `make`, `model`, `year`,`eng_size`,`price`, `contact`,`frontim`, `leftim`, `rightim` ,`backim`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
if (!mysqli_stmt_prepare($stmt, $sell)) {
  ...
  mysqli_stmt_bind_param($stmt, "issiiisbbbb", $sid,$makename,$model,$year,$eng_size,$price,$contact,$null,$null,$null,$null);
