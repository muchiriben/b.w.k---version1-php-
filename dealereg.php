...
<input type="text" placeholder="Phone Number e.g 0712345678" name="pnumber" id="pnumber" required>
<input type="email" placeholder="Email e.g biker@gmail.com" name="email" id="email" required><br>
<input type="text" placeholder="Website(optional) e.g bikerworld.co.ke" name="web" id="web">
