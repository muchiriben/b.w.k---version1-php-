...
$sell ="UPDATE `puploads` SET frontim='$imagetmp1',leftim = '$imagetmp2',rightim = '$imagetmp3',backim = '$imagetmp4' WHERE pid ='$p_id'";
...
<header class="header">	
  <?php require_once 'inc/nav.php'; ?>
		<div class="form">
	<h1>UPLOAD IMAGES</h1>
<form action="pimg.php" method="post" enctype="multipart/form-data">
